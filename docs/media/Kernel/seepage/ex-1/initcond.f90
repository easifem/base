...
real( dfp ), parameter :: rho_w = 1.0E+3
type(domain_) :: dom
type(gmsh_) :: gmsh
type( seepage_ ) :: seep
type(file_) :: afile
...
allocate( damprops( 3, 2 ) )
damprops( :, 1 ) = [1.0E-10, 1.0E-10, 1.0E-10] !! muw, ks
damprops( :, 2 ) = [1.0E-10, 1.0E-10, 1.0E-10] !! muw, ks
