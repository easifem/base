...
MODULE GaussLegendre_Triangle_Methods
USE BaseMethod
IMPLICIT NONE
PRIVATE
PUBLIC :: getGaussLegendreQPTriangle1
PUBLIC :: getGaussLegendreQPTriangle2
...
FUNCTION getGaussLegendreQPTriangle1(order) &
  & RESULT(obj)
...
FUNCTION getGaussLegendreQPTriangle2(nips) RESULT(obj)
