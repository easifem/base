...
USE FEVariable_Vector_Scalar_Subtraction, ONLY: Vector_Scalar_Master
USE FEVariable_Vector_Vector_Subtraction, ONLY: Vector_Vector_Master
...
END SELECT
END PROCEDURE fevar_Subtraction_3
