...
PURE SUBROUTINE Matrix_Scalar_Master(obj1, obj2, ans, varCase)
  ...
  END SELECT
END SUBROUTINE Matrix_Scalar_Master
...
PURE SUBROUTINE constant_space(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); np = obj2%s(1)
  ...
  DO CONCURRENT(ii=1:nx, jj=1:ny, kk=1:np)
    ans%val(FortranIndex(ii, jj, kk, nx, ny, np)) = &
      obj1%val(FortranIndex(ii, jj, nx, ny)) _OP_ &
      obj2%val(kk)
  END DO
...
PURE SUBROUTINE constant_time(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); nnt = obj2%s(1)
...
PURE SUBROUTINE constant_spacetime(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); np = obj2%s(1); nnt = obj2%s(2)
  ...
  DO CONCURRENT(ii=1:nx, jj=1:ny, kk=1:np, ll=1:nnt)
    ans%val(FortranIndex(ii, jj, kk, ll, nx, ny, np, nnt)) = &
      obj1%val(FortranIndex(ii, jj, nx, ny)) _OP_ &
      obj2%val(FortranIndex(kk, ll, np, nnt))
  END DO
...
PURE SUBROUTINE space_space(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); np = MIN(obj1%s(3), obj2%s(1))
  ans%s(1) = nx; ans%s(2) = ny; ans%s(3) = np
  ans%len = nx * ny * np

  DO CONCURRENT(ii=1:nx, jj=1:ny, kk=1:np)
    ans%val(FortranIndex(ii, jj, kk, nx, ny, np)) = &
      obj1%val(FortranIndex(ii, jj, kk, nx, ny, np)) _OP_ &
      obj2%val(kk)
  END DO
...
PURE SUBROUTINE space_time(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); np = obj1%s(3); nnt = obj2%s(1)
  ans%s(1) = nx; ans%s(2) = ny; ans%s(3) = np; ans%s(4) = nnt
...
PURE SUBROUTINE space_spacetime(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2)
  np = MIN(obj1%s(3), obj2%s(1))
  nnt = obj2%s(2)
...
PURE SUBROUTINE time_time(obj1, obj2, ans)
  ...
  DO CONCURRENT(ii=1:nx, jj=1:ny, ll=1:nnt)
    ans%val(FortranIndex(ii, jj, ll, nx, ny, nnt)) = &
      obj1%val(FortranIndex(ii, jj, ll, nx, ny, nnt)) _OP_ &
      obj2%val(ll)
  END DO
...
PURE SUBROUTINE time_space(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); nnt = obj1%s(3); np = obj2%s(1)
  ans%s(1) = nx; ans%s(2) = ny; ans%s(3) = np; ans%s(4) = nnt
...
PURE SUBROUTINE spacetime_space(obj1, obj2, ans)
  ...
  DO CONCURRENT(ii=1:nx, jj=1:ny, kk=1:np, ll=1:nnt)
    ans%val(FortranIndex(ii, jj, kk, ll, nx, ny, np, nnt)) = &
      obj1%val(FortranIndex(ii, jj, kk, ll, nx, ny, np, nnt)) _OP_ &
      obj2%val(kk)
  END DO
...
PURE SUBROUTINE spacetime_time(obj1, obj2, ans)
  ...
  nx = obj1%s(1); ny = obj1%s(2); np = obj1%s(3)
  nnt = MIN(obj1%s(4), obj2%s(1))
