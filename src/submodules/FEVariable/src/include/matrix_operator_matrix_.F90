...
PURE SUBROUTINE Matrix_Matrix_Master(obj1, obj2, ans, varCase)
...
PURE SUBROUTINE constant_space(obj1, obj2, ans)
  ...
  nx = MIN(obj1%s(1), obj2%s(1))
  ny = MIN(obj1%s(2), obj2%s(2))
  np = obj2%s(3)
