...
SUBMODULE(CSRMatrix_Method) SetBlockRowMethods
USE BaseMethod
IMPLICIT NONE
CONTAINS
...
MODULE PROCEDURE csrMat_setBlockRow1
  ...
  !!
  c = getNodeLoc( obj=dofobj, idof=(dofobj .DOFStartIndex. jvar) )
  col_start = c( 1 ) ! start
  c = getNodeLoc( obj=dofobj, idof=(dofobj .DOFEndIndex. jvar) )
  col_end = c( 2 ) ! end
  !!
...
MODULE PROCEDURE csrMat_setBlockRow3
  CALL SetBlockRow( &
    & obj=obj, &
    & jvar=jvar, &
    & irow=getNodeLoc(obj=obj%csr%dof, nodeNum=nodenum, &
    & ivar=ivar, idof=idof), &
    & value=value )
...
END SUBMODULE SetBlockRowMethods