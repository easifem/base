...
SUBMODULE(RealVector_Method) Norm2ErrorMethods
USE BaseMethod
IMPLICIT NONE
CONTAINS
...
MODULE PROCEDURE realvec_norm2error_1
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_1
...
MODULE PROCEDURE realvec_norm2error_2
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_2
...
MODULE PROCEDURE realvec_norm2error_3
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_3
...
MODULE PROCEDURE realvec_norm2error_4
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_4
...
MODULE PROCEDURE realvec_norm2error_5
  ...
  p=GetNodeLoc( &
    ...
    & obj=dofobj2, &
    & ivar=ivarobj2, &
    & spaceCompo=spaceCompoobj2, &
    & timeCompo=timeCompoobj2 ))
  !!
  jj = 0; ans=0.0_DFP
  !!
  DO ii = s(1), s(2), s(3)
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_5
...
MODULE PROCEDURE realvec_norm2error_6
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_6
...
MODULE PROCEDURE realvec_norm2error_7
  ...
  ans = SQRT( ans )
  !!
END PROCEDURE realvec_norm2error_7

END SUBMODULE Norm2ErrorMethods