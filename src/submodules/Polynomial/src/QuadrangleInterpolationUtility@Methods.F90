...
MODULE PROCEDURE CellBasisGradient_Quadrangle2_
...
DO k1 = 2, pb
  DO k2 = 2, qb
    cnt = cnt + 1
    ans(1:dim1, cnt, 1) = dL1(1:dim1, k1) * L2(1:dim1, k2)
    ans(1:dim1, cnt, 2) = L1(1:dim1, k1) * dL2(1:dim1, k2)
  END DO
END DO
END PROCEDURE CellBasisGradient_Quadrangle2_
