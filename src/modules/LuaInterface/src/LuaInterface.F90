...
INTERFACE
  ...
  FUNCTION lua_load(l, reader, DATA, chunkname, mode) &
    BIND(c, name='lua_load')
...
INTERFACE
  ...
  ! lua_KContext ctx, lua_CFunction k)
...
INTERFACE
  ...
  SUBROUTINE lua_pushlightuserdata(l, p) &
    BIND(c, name='lua_pushlightuserdata')
    IMPORT :: C_PTR
    TYPE(C_PTR), INTENT(IN), VALUE :: l
