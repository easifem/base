...
INTERFACE
  ...
  FUNCTION CheckCollisionBoxSphere(box, center, radius) BIND(c, &
    ...
    IMPORT :: bounding_box_, C_BOOL, C_FLOAT, vector3_
    IMPLICIT NONE
  ...
  FUNCTION CheckCollisionBoxes(box1, box2) BIND(c, name='CheckCollisionBoxes')
    IMPORT :: bounding_box_, C_BOOL
    IMPLICIT NONE
    TYPE(bounding_box_), INTENT(in), VALUE :: box1
    TYPE(bounding_box_), INTENT(in), VALUE :: box2
  ...
  FUNCTION CheckCollisionCircleRec(center, radius, rec) BIND(c, &
    ...
    IMPORT :: C_BOOL, C_FLOAT, rectangle_, vector2_
    IMPLICIT NONE
  ...
  ! bool CheckCollisionCircles(Vector2 center1, float radius1, Vector2 center2, float radius2)
    ...
    IMPORT :: C_BOOL, C_FLOAT, vector2_
    IMPLICIT NONE
    TYPE(vector2_), INTENT(in), VALUE :: center1
    REAL(kind=C_FLOAT), INTENT(in), VALUE :: radius1
    TYPE(vector2_), INTENT(in), VALUE :: center2
  ...
  ! bool CheckCollisionLines(Vector2 startPos1, Vector2 endPos1, Vector2 startPos2, Vector2 endPos2, Vector2 *collisionPoint)
    ...
    IMPORT :: C_BOOL, vector2_
    IMPLICIT NONE
    TYPE(vector2_), INTENT(in), VALUE :: start_pos1
    TYPE(vector2_), INTENT(in), VALUE :: end_pos1
    TYPE(vector2_), INTENT(in), VALUE :: start_pos2
    TYPE(vector2_), INTENT(in), VALUE :: end_pos2
    TYPE(vector2_), INTENT(out) :: collision_point
  ...
  ! bool CheckCollisionPointCircle(Vector2 point, Vector2 center, float radius)
    ...
    IMPORT :: C_BOOL, C_FLOAT, vector2_
    IMPLICIT NONE
    TYPE(vector2_), INTENT(in), VALUE :: point
    TYPE(vector2_), INTENT(in), VALUE :: center
    REAL(kind=C_FLOAT), INTENT(in), VALUE :: radius
  ...
  ! bool CheckCollisionPointRec(Vector2 point, Rectangle rec)
    ...
    IMPORT :: C_BOOL, rectangle_, vector2_
    IMPLICIT NONE
    TYPE(vector2_), INTENT(in), VALUE :: point
    TYPE(rectangle_), INTENT(in), VALUE :: rec
  ...
  ! bool CheckCollisionSpheres(Vector3 center1, float radius1, Vector3 center2, float radius2)
    ...
    IMPORT :: C_BOOL, C_FLOAT, vector3_
    IMPLICIT NONE
    TYPE(vector3_), INTENT(in), VALUE :: center1
    REAL(kind=C_FLOAT), INTENT(in), VALUE :: radius1
    TYPE(vector3_), INTENT(in), VALUE :: center2
    REAL(kind=C_FLOAT), INTENT(in), VALUE :: radius2
