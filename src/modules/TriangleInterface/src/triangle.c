...
void info() {
  ...
  printf("        alternative bound on the minimum angle, replacing 20 "
         "degrees, may\n");
  printf("        be specified after the `q'.  The specified angle may include "
         "a\n");
  ...
  printf("        constraint by invoking the -a switch twice, once with and "
         "once\n");
  printf("        without a number following.  Each area specified may include "
         "a\n");
  ...
  printf("        possibly failure if Triangle runs out of precision).  If you "
         "are\n");
  printf("        refining a mesh, the -c switch works differently:  it causes "
         "a\n");
  ...
  printf("        intersections, even if it needs to use more vertices than "
         "the limit\n");
  printf("        you set.  When Triangle inserts segments by splitting (-s), "
         "it\n");
  ...
  printf("  A constrained Delaunay triangulation (CDT) of a PSLG is similar to "
         "a\n");
  ...
  printf("  vertices and edges occur on a boundary of the triangulation.  A "
         "common\n");
  printf("  use is to determine where boundary conditions should be applied to "
         "a\n");
  ...
  printf("  from segment 1.  Vertices 6 and 8 have markers from segment 4.  "
         "All the\n");
  printf("  other vertices but 4 have been marked to indicate that they lie on "
         "a\n");
  printf("  boundary.\n\n");
  printf("    12  2  0  1\n");
  printf("       1    0   0      5\n");
  ...
  printf("  constraints in .area files are used only to refine an existing "
         "mesh, and\n");
  printf("  are typically based on a posteriori error estimates resulting from "
         "a\n");
  ...
  printf("  geometrically identical to linear elements, even though they can "
         "be used\n");
  printf("  with quadratic interpolating functions.  The three extra nodes of "
         "an\n");
  ...
  printf("  Marshall Bern, L. Paul Chew, Kenneth L. Clarkson, Boris Delaunay, "
         "Rex A.\n");
  printf("  Dwyer, David Eppstein, Steven Fortune, Leonidas J. Guibas, Donald "
         "E.\n");
  printf("  Knuth, Charles L. Lawson, Der-Tsai Lee, Gary L. Miller, Ernst P. "
         "Mucke,\n");
  printf("  Steven E. Pav, Douglas M. Priest, Jim Ruppert, Isaac Saias, Bruce "
         "J.\n");
