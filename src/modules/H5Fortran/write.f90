...
module procedure writeattr
  ...
  type is( real(real32) )
    call H5LTSET_ATTRIBUTE_FLOAT_F(self%lid, dname, attr, [attrval], one, ier)
  type is( real(real64) )
    call H5LTSET_ATTRIBUTE_DOUBLE_F(self%lid, dname, attr, [attrval], one, ier)
  type is( integer(int32) )
    call H5LTSET_ATTRIBUTE_INT_F(self%lid, dname, attr, [attrval], one, ier)
  end select
