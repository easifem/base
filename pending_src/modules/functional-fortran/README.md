...
- [Example usage](#example-usage)
  ...
  - [More functional: `map`, `filter`, `fold`, `unfold`](#more-functional-map-filter-fold-unfold)
  - [Set functions: `set`, `union`, `intersection`, `complement`](#set-functions-set-union-intersection-complement)
